...
<div class="modal fade" id="deleteConfirmationModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete <span id="departmentNameSpan" class="fw-bold"></span> department?</p>
            </div>
            <div class="modal-footer">
                <button class="btn btn-sm btn-secondary" data-bs-dismiss="modal"> Cancel </button>
                <form method="POST">
                    <input type="hidden" id="departmentIdToDeleteInput" name="departmentIdToDelete">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteModal.addEventListener('show.bs.modal', function (event) {
            ...
            var departmentNameSpan = document.getElementById('departmentNameSpan');
            var departmentIdToDeleteInput = document.getElementById('departmentIdToDeleteInput');
