...
<head>
    <title> <?php echo $employeeId . " - WHS Folder" ?></title>
    ...
    if (is_dir($fullDirectory)) {
        ...
        foreach ($filesAndDirs as $item) {
            ...
            if (is_dir($itemPath)) {
                ...
                $fileUrl = 'open-whs-file.php?file=' . urlencode($item) . "&folder=" . urlencode($folder) . "&employee_id=" . urlencode($employeeId) . "&dir=" . urlencode($currentDir);
